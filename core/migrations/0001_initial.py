    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_name', models.CharField(blank=True, default='Гость', max_length=100, verbose_name='Имя клиента')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('not_approved', 'Не подтверждена'), ('approved', 'Подтверждена'), ('in_progress', 'В процессе'), ('done', 'Выполнена')], default='not_approved', max_length=50, verbose_name='Статус заявки')),
