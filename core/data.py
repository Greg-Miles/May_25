masters = [
    {"id": 1, "name": "Эльдар 'Бритва' Рязанов", "photo": "img/Рязанов.webp",},
    {"id": 2, "name": "Зоя 'Ножницы' Космодемьянская", "photo": "img/Космодемьянская.webp",},
    {"id": 3, "name": "Борис 'Фен' Пастернак", "photo": "img/Пастернак.webp",},
    {"id": 4, "name": "Иннокентий 'Лак' Смоктуновский", "photo": "img/Смоктуновский.webp",},
    {"id": 5, "name": "Раиса 'Бигуди' Горбачёва", "photo": "img/Gorbacheva.webp",},
]


# Список возможных услуг барбершопа
services = [
    {"name":"Стрижка под 'Горшок'", "price": 1000,},
    {"name":"Укладка 'Взрыв на макаронной фабрике'", "price": 1500,},
    {"name":"Королевское бритье опасной бритвой", "price": 2000,},
    {"name":"Окрашивание 'Жизнь в розовом цвете'", "price": 2500,},
    {"name":"Мытье головы 'Душ впечатлений'", "price": 300,},
    {"name":"Стрижка бороды 'Боярин'", "price": 1000,},
    {"name":"Массаж головы 'Озарение'", "price": 500,},
    {"name":"Укладка 'Ветер в голове'", "price": 1000,},
    {"name":"Плетение косичек 'Викинг'", "price": 1000,},
    {"name":"Полировка лысины до блеска", "price": 800,},
]
